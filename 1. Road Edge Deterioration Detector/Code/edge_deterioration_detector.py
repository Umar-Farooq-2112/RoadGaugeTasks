...
def edge_deterioration_detector(image,mask,pixel_per_mm,edge_threshold=50,deterioration_threshold_mm = 80,line_method = 0):
...
#     print(f"{names[i]}:    {edge_deterioration_detector(image,mask,1/mmperpx,50,80)}")
